...
const sortOptions = [
  ...
  { name: "Stock: Low to High", href: "stock_low", current: false },
  { name: "Stock: High to Low", href: "stock_high", current: false },
];
const sortLimit = [
  { name: "9 Products", href: "9", current: false },
  { name: "15 Products", href: "15", current: false },
  { name: "21 Products", href: "21", current: false },
];
...
export default function ShopProduct() {
  ...
  const categoryId = searchParamms.get("categoryId");
  const colorValue = searchParamms.get("color");
  const sizeValue = searchParamms.get("size");
  const priceValue = searchParamms.get("price");
  const minDiscount = searchParamms.get("discount") || 0;
  const sortValue = searchParamms.get("sort") || "stock_high";
  const limitValue = searchParamms.get("limit") || 9;
  const pageNumber = searchParamms.get("page") || 1;
  const keyword = searchParamms.get("keyword");
  ...
  return (
    <div className="bg-white">
      <div>
        ...
        <main className=" sm:px-6 lg:px-20 ">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-3.5 pt-14 px-4 ml-16 mr-16">
            ...
            <div className="flex items-center px-4 ">
              ...
              <Menu
                as="div"
                className="relative inline-block text-left ml-3 z-30"
              >
                <div>
                  <Menu.Button className="group inline-flex justify-center text-sm font-medium text-gray-700 hover:text-gray-900">
                    Show: {limitValue}
                ...
                >
                  <Menu.Items className="absolute right-0 z-10 mt-2 w-40 origin-top-right rounded-md bg-white shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <div className="py-1">
                      {sortLimit.map((option) => (
                        <Menu.Item key={option.name}>
                          {({ active }) => (
                            <a
                              onClick={(e) =>
                                handleFilterChange("limit", option.href)
                              }
                              className={classNames(
                                option.current
                                  ? "font-medium text-gray-900"
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-4">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4 ml-16 mr-16 ">
              <div>
                <div className="">
                  ...
                  <form className="hidden lg:block">
                    ...
                    >
                      <>
                        ...
                        <Disclosure.Panel className="pt-3 ml-2">
                                ...
                                {section.options.map((option, optionIdx) => (
                                  ...
                                  >
                                    ...
                                    <label
                                      ...
                                      className="ml-3 text-sm text-gray-600 mb-0"
                                    >
                                      {option.label}
                                    </label>
                                  </div>
              ...
              <div className="lg:col-span-3 w-full">
                <div className="flex flex-wrap justify-left justify-between pr-4 pl-4 bg-white py-5 ">
                  {products?.map((item) => (
